		...
		<div class="main">
			...
			<div class="fieldset">
				...
				<ul class="form-list">
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								...
								<input type="text" class="required-entry input-text" id="firstname" name="firstname" maxlength="14" required>
							</div>
							<div class="clear"></div>
						</div>                
					</li>
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								...
								<input type="text" class="required-entry input-text" id="lastname" name="lastname" maxlength="14" required>
							</div>
							<div class="clear"></div>
						</div>                
					</li>
					<li>
						<div class="input-box">
							...
							<input type="text" class="input-text validate-email required-entry" id="email" name="email" maxlength="120" required>
						</div>
						<div class="clear"></div>
					</li>
					<li>
					...
					<li class="fields">
						<div class="customer-name">
							<div class="input-box name-firstname">
								...
								<input type="text" class="required-entry input-text" id="username" name="username" maxlength="14" required>
							</div>
							<div class="clear"></div>
						</div>                
					</li>
				...
				<div class="buttons-set">
					...
					<a href="account_login.php" title="Back" class="f-left">&laquo; Back</a>
					<input type="button" id="register_button" class="colors-btn" value="Register">
					<div class="clear"></div>
				</div>
			</form>
        </div>
